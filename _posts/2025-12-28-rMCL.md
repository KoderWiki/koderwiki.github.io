...
만약 Gaussian Mixture Model을 따른다면
$$
\hat p(y|x) = \sum_{k=1}^K \gamma_\theta^k(x) \mathcal N (y | f_\theta ^k (x), \Sigma _k)
$$

### Reference
V. Letzelter, M. Fontaine, M. Chen, P. Pérez, S. Essid, and G. Richard, <br>
“Resilient Multiple Choice Learning: A Learned Scoring Scheme with Application to Audio Scene Analysis,” <br>
(NeurIPS 2023)